...
import { Star, X, Send, Loader2, MessageSquare, AlertCircle, CheckCircle2 } from 'lucide-react';
        ...
        <div className="p-6 border-b border-slate-100 flex items-center justify-between bg-slate-50/50">
          <div className="flex items-center gap-3">
            <div className="relative w-12 h-12 rounded-xl overflow-hidden bg-slate-100 border border-slate-200 flex-shrink-0">
              <Image src={productImage} alt={productTitle} fill sizes="48px" className="object-cover" />
            </div>
            <div>
              <h3 className="font-extrabold text-slate-900 text-sm sm:text-base">{productTitle}</h3>
